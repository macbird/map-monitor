    ...
    let icons = {
        error:
            <svg className="w-12 h-12 fill-current text-red-500"
                 ...
                 viewBox="0 0 700 600">
                <path
                    d="m350 14c-146.68 0-266 119.32-266 266s119.32 266 266 266 266-119.32 266-266-119.32-266-266-266zm0 498.75c-128.34 0-232.75-104.41-232.75-232.75s104.41-232.75 232.75-232.75 232.75 104.41 232.75 232.75-104.41 232.75-232.75 232.75z"/>
                <path
        ...
        danger:
            <svg className="w-12 h-12 fill-current text-yellow-500"
                ...
                <path xmlns="http://www.w3.org/2000/svg"
                      d="m199.92 482.72h299.6c25.762 0 48.719-13.441 61.602-35.281 12.879-22.398 12.879-48.719 0.55859-71.121l-150.08-263.2c-12.879-22.398-35.84-35.84-62.16-35.84-26.32 0-49.281 13.441-62.16 35.84l-150.08 263.2c-12.879 22.398-12.32 48.719 0.55859 71.121 13.434 22.402 36.395 35.281 62.156 35.281zm-27.441-86.797 150.08-263.2c5.6016-10.078 16.238-16.238 28-16.238 11.762 0 21.84 6.1602 28 16.238l150.08 263.2c5.6016 10.078 5.6016 21.84 0 31.922-5.6016 10.078-16.238 15.68-27.441 15.68l-301.27-0.003907c-11.762 0-21.84-6.1602-27.441-15.68-5.6016-10.078-6.1602-21.84 0-31.918z"/>
                <path xmlns="http://www.w3.org/2000/svg"
                      d="m347.2 344.4c10.641 0 19.602-8.9609 19.602-19.602v-106.4c0-10.641-8.9609-19.602-19.602-19.602-10.641 0.003906-19.598 8.9648-19.598 19.602v106.4c0 10.645 8.957 19.602 19.598 19.602z"/>
                <path xmlns="http://www.w3.org/2000/svg"
                      d="m347.2 417.2c10.641 0 19.602-8.9609 19.602-19.602v-16.801c0-10.641-8.9609-19.602-19.602-19.602-10.641 0.003907-19.598 8.9648-19.598 19.605v16.801c0 10.637 8.957 19.598 19.598 19.598z"/>
            </svg>,
        info:
            <svg className="w-12 h-12 fill-current text-blue-500"
                ...
                <g fill="none" stroke="#646cff" stroke-linecap="round" stroke-linejoin="round" stroke-width="2">
                    <path transform="matrix(23.333 0 0 23.333 70 0)"
                          d="m23 12c0 6.0752-4.9249 11-11 11s-11-4.9249-11-11 4.9249-11 11-11 11 4.9249 11 11"/>
            ...
            <div className="backdrop absolute bg-orange ">
                <motion.div initial={{
                    ...
                    y: 60, scale: 0.5
                            ...
                            }} className="alert absolute bg-white">
