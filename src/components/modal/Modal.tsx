                ...
                <div
                    ...
                    >
                        ...
                        <div className="flex flex-row justify-start form">
                            ...
                            {searchable?<motion.div  animate={expanded?"open":"closed"} variants={variants} className="mr-6 text-end">
                                    <TextField
                                        ...
                                        startAdornment: (
                                            <InputAdornment position="start">
                                                <FiSearch className={!expanded?'cursor-pointer ml-4 w-5 h-5':'w-5 h-5' }/>
                                            </InputAdornment>
                                        ),
                                        endAdornment: (
                                            <InputAdornment onClick={(event)=>{
                                                ...
                                                {search?<MdClose  className=" cursor-pointer  mt-2 w-4 h-4"/>:null}
                                            </InputAdornment>
                                          ),
                                        }}
                                        variant="outlined"
                            ...
                            <MdClose onClick={close} className="absolute top-0 right-0 cursor-pointer mr-4 mt-2 w-5 h-5"/>
