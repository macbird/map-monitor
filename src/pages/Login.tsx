                            ...
                            <div className="min-h-screen sm:flex sm:flex-row mx-0 justify-center">
                                <div className="flex-col ml-80 flex  self-center p-10 sm:max-w-5xl xl:max-w-2xl  z-10">
                                    <div className="self-start hidden lg:flex flex-col  text-white">
                                        ...
                                        <h1 className="mb-3 font-bold drop-shadow-2xl text-purple-600 text-5xl">Sistema de monitoramento </h1>
                                        <p className="text-black pr-3">Lorem ipsum is placeholder text commonly used in the graphic, print,
                                    ...
                                    <div className="p-12 bg-white mx-auto rounded-2xl w-100 ">
                                        ...
                                        <div className="space-y-5">
                                            ...
                                            <div className="space-y-2">
                                                ...
                                                <Field name="password" className="w-full content-center text-base px-4 py-2 border  border-gray-300 rounded-lg focus:outline-none focus:border-purple-400"
                                                       type="password" />
                                            </div>
